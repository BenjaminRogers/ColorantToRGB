...
# I think this basic outline is correct. This is the algorithm.
def convert_rgb(color):
    redshift = 0
    greenshift = 0
    blueshift = 0
    for i in range(len(color)):
        # For each colorant that the user has chosen, we calculate how drastically the rgb value is changed.
...
pygame.draw.rect(screen, match_color, (300, 300, 50, 25))
pygame.display.flip()
while True:
    pass
